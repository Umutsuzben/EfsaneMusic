...
async def start(_, message: Message):
         ...
         reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "🔊 Asistan", url="https://t.me/goxyoutube"
                    ),
                    InlineKeyboardButton(
                        "💬 Sohbet", url="https://t.me/Sohbetgox"
                    )
                ],
                [
                    InlineKeyboardButton(
                    ...
                    InlineKeyboardButton(
                        "Resmi Kanal 🇹🇷", url=f"https://t.me/umutsuzhizmet"
                    )
                ]
